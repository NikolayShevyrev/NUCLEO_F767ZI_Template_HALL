				  	  	  	  	  	  ...
				  	  	  	  	  	  OutputType type , OutputSpeed speed, IOPull pull)
{
	...
	CLEAR_BIT(port->OTYPER, (GPIO_OTYPER_OT0 << pin));
	SET_BIT(port->OTYPER, (type << pin));						// Output type configuration

	CLEAR_BIT(port->OSPEEDR, (GPIO_OSPEEDR_OSPEEDR0 << (pin*2)));
